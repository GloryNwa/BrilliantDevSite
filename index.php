              ...
              <div class="row">
                <div class="span6">
                  ...
                  <p class="animated fadeInUp"style="font-size:16px !important; color: #fff;font-size:19px!important">  
                   As Brilliant Web Developers, we help our clients translate their business needs into an efficient web application
                 by creating beautiful and engaging digital journeys to ensure that the target audience have the very
                 ...
                 <!--  <a href="contact.php" class="btn btn-success btn-large animated fadeInUp">
                  ...
                  <a href="contact.php" class="btn btn-theme btn-large animated fadeInUp" style="background-color:#ff5821 !important">
                      <i class="icon-phone"></i>&nbsp; Contact us today
                    </a>
                </div>
                <div class="span6">
                  <img src="img/slides/camera/slide1/webb.png" alt="" class="animated bounceInDown delay1" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="span12">
            ...
            <h4 style="text-align: center"><strong><span> Cutting-edge Brilliant</span>     Web Solutions</strong></h4>
             <h6  style="text-align: center"> Everything required for your web solutions sorted at a single place!</h6><br><br>
              <div class="span4">
                ...
                <!--     <i class="ico icon-circled icon-bgdark icon-star active icon-3x"></i> -->
                  ...
                  <div class="">
                    <h5> Quality Design, Development and<strong> Search Engine Friendly</strong></h5>
                    <p>
                      No one designs to their audience better than Brilliant Developers. Our UI/ UX experts offers appealing and intaractive user experience with stunning visual elegance to produce a complete package of purpose-driven, insightful design that works just the right way for your target audience and also its visibility on search engines by employing SEO best practices during development. We ensure that Google and other search engines easily find the website’s pages.- Discover the developers difference.
                    </p>
                    <a href="#"></a>
                  </div>
                </div>
...
<!--                     <i class="ico icon-circled icon-bgdark icon-laptop active icon-3x"></i>
 -->                  </div>
                  <div class="">
                    <h5>Modern & Mobile<strong> Responsive</strong></h5>
                    <p>
